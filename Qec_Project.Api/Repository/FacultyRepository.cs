...
namespace QEC_Project.API.Repository
{
...

  {
    ...
    public async Task<Result<ResponseFacultyDTO>> CreateFaculty(FacultyDTO dto)
    {
      ...
      {
        return Result<ResponseFacultyDTO>.Failure(e.Message);
    ...
    public async Task<Result<List<ResponseFacultyDTO>>> GetAllFaculty()
    {
      try
      {
        ...
        {
          return Result<List<ResponseFacultyDTO>>.Failure("No Faculty");
        }
        ...
        return Result<List<ResponseFacultyDTO>>.OK(fac);
      }
      catch (Exception e)
      {
        return Result<List<ResponseFacultyDTO>>.Failure(e.Message);
    ...
    public async Task<ResponseDTO> UpdateFacultyInfo(UpdateFacultyDTO dto)
    {
      ...
      {
        return new ResponseDTO(true, e.Message);
